    ...
    <section className="min-h-screen bg-[#0B0B0D] flex flex-col justify-center items-center py-12 px-2">
      ...
      <div className=" w-full  pb-10 pt-6 px-3 md:px-8 shadow-xl relative">
        ...
        <div className="flex flex-col items-center">
          <h1
            className="text-5xl md:text-6xl text-white mb-8 font-normal"
            style={{
        ...
        <div className="grid md:grid-cols-2 gap-10 md:ml-16 md:mr-16">
          ...
          <CurvedBorder className="p-2" strokeColor="#ffffffff" strokeWidth={2}>
          <CurvedBorder className="p-1" strokeColor="#ffffffff" strokeWidth={1}>
          <div className="p-8 bg-[#0B0B0D] relative">
            
            <h2
              className="text-2xl md:text-2xl text-white mb-5 font-bold flex justify-center"
              style={{
                fontFamily: "'Cinzel Decorative', serif",
            ...
            <p
              className="text-xl text-[#f7f7f7] leading-8 mb-7"
              style={{
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-yellow-400 text-2xl font-bold">
                  <svg width="30vw" height="3vh" viewBox="0 0 471 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <line x1="210.374" y1="15.9238" x2="33.0247" y2="15.9238" stroke="#ECC363" stroke-width="3"/>
                    <line y1="-1.5" x2="177.349" y2="-1.5" transform="matrix(1 0 0 -1 261.265 14.4238)" stroke="#ECC363" stroke-width="3"/>
              ...
              <div className="flex flex-row gap-6 justify-around w-full text-base text-[#d3d3d3]" style={{ fontFamily: centaurFont }}>
                <div className="flex flex-col items-center">
          ...
          {/* Right: Rewards */}
          <CurvedBorder className="p-2" strokeColor="#ffffffff" strokeWidth={2}>
          <CurvedBorder className="p-1 h-100" strokeColor="#ffffffff" strokeWidth={1}>
            <div className=" p-8 bg-[#0B0B0D] relative flex flex-col items-center">
            <h2
              className="text-3xl md:text-3xl text-white mb-5 font-bold"
              style={{
                fontFamily: "'Cinzel Decorative', serif",
                letterSpacing: "0.02em",
              }}
            ...
            <div className="flex flex-col gap-5 w-full">
              <div className="w-full h-14 bg-gradient-to-r from-[#d6af60] via-[#cdb88a] to-[#0B0B0D] rounded-lg flex items-center px-6">
                <span
              ...
              <div className="w-full h-14 bg-gradient-to-r from-[#4689a7] via-[#61a2b1] to-[#0B0B0D] rounded-lg flex items-center px-6">
                <span
                  className="text-xl text-white font-bold"
                  style={{ fontFamily: "'Cinzel Decorative', serif" }}
                >
