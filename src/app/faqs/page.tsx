...
const questionsanswers = [
  ...
  return (
    <>
      ...
      <div className="relative  w-full flex sm:top-[10vh]  flex-col justify-start items-center text-white ">
     

        <div className="w-full h-[80vh]  max-w-4xl flex flex-col items-center">
          <h1
        ...
        FAQs
          ...
          <div className="w-full flex flex-col gap-6 sm:max-h-[50vh] max-h-[60vh]  overflow-y-auto pr-2">
